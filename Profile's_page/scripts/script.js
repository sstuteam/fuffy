...
$('#modal-body-albums').html('<div class="row"><div class="col-sm-3 col-xs-3"> <img class="row album-name size albums-sm-in-modal" src="images/1-2.jpg"/><a>Album s Name</a></div></div>' + '<br /><div class="row"><div class="col-sm-6 album-name"><a>Add a new album</a></div></div>');